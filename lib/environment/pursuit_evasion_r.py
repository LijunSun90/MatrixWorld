...
class MatrixWorld(MatrixWorldTwoSwarmConcurrentBase):
    ...
    def update_game_status(self):
        ...
        # Ending 1.
        # When all evaders are all captured simultaneously, the game is done.
        # Example task: multi-agent path finding (MAPF), if the evaders are static.
        ...
        # Ending 2.
        # No agents will disappear and the game will never end.
