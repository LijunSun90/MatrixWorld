...
from lib.agent.agent_do_nothing import DoNothingAgent
...
class RunExperiment:
    ...
    def step_3_create_trainer_agent(self):
        ...
        self.evader = DoNothingAgent(self.args.n_evaders)
    ...
    def step_4_1_experiment_of_an_epoch(self):
        ...
        for timestep in range(self.args.steps_per_epoch):
            ...
            actions_evader = self.evader(observations_actor_evader)
